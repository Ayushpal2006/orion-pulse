...
const CreatePurchaseItemSchema = z.object({
  ...
  selling_price: z.number().nonnegative("Selling price must be greater than or equal to 0"),
});
...
export const CreatePurchaseSchema = z.object({
  ...
  purchase_date: z.string().datetime({ precision: 3, offset: true }).optional().nullable().or(z.literal("")),
