    ...
    <div className="fixed bottom-20 left-4 right-4 z-40 flex flex-col gap-3 rounded-2xl border border-border bg-elevated/95 p-4 shadow-xl backdrop-blur-md transition-all md:bottom-6 md:right-6 md:left-auto md:w-96">
      <div className="flex items-start justify-between gap-2">
        <div className="flex gap-3">
          <img src="/logo.png" alt="Apka Bill Logo" className="size-10 shrink-0 rounded-xl object-cover shadow-sm border border-border/50" />
          <div>
            <h4 className="text-sm font-semibold tracking-tight">Install Apka Bill App</h4>
            <p className="mt-0.5 text-xs text-muted-foreground leading-relaxed">
              Add Apka Bill to your home screen for quick launch and offline operation.
            </p>
          </div>
        </div>
        <button
